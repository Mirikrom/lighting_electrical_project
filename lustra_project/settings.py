"""
Django settings for lustra_project project.
...
SECRET_KEY = 'django-insecure-k_i__q&lz7a(96#!y#8=(zizm_a%0*4&#_!b08rl1&$g7r8ge*'
...
WSGI_APPLICATION = 'lustra_project.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'lustra.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
